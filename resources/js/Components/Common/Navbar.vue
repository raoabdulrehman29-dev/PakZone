        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between h-16">
                ...
                <div class="flex items-center gap-2">
                    ...
                    <div class="hidden md:flex items-center gap-2">
                        <a href="/login" class="px-4 py-1.5 text-sm text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
                            Sign In
                        </a>
                        <a href="/register" class="px-4 py-1.5 text-sm font-medium text-white bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 rounded-lg transition-all duration-200 shadow-lg shadow-teal-500/30 hover:shadow-teal-500/40">
                            Sign Up
                        </a>
                    </div>

                    <!-- Cart -->
                    <a href="/cart" class="relative p-2 hover:bg-gray-800 rounded-lg transition-colors group">
            ...
            <div class="md:hidden pb-3" v-show="isMobileMenuOpen">
                ...
                <div class="flex items-center gap-2 mt-3">
                    <a href="/login" class="flex-1 text-center px-4 py-2 text-sm text-gray-300 hover:text-white hover:bg-gray-800 rounded-lg transition-colors">
                        Sign In
                    </a>
                    <a href="/register" class="flex-1 text-center px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-teal-600 to-teal-500 hover:from-teal-700 hover:to-teal-600 rounded-lg transition-all duration-200">
                        Sign Up
                    </a>
                </div>
            </div>
